...
class HFConvertConfig:
    ...
    padding_side: str = "right"                                            # Tokenizer padding_side for conversion
...
def convert_prismatic_weights_to_hf(cfg: HFConvertConfig) -> None:
    ...
    # NOTE: This conversion script uses single-example tokenization, so `padding_side="right"` is correct.
    # Batched generation should use `padding_side="left"` when implemented.
