...
Example usage:
    ...
    python experiments/robot/aloha/preprocess_split_aloha_data.py \
        --dataset_path /path/to/aloha1_raw/put_green_pepper_into_pot/ \
        --out_base_dir /path/to/aloha1_preprocessed/ \
        --percent_val 0.05 && \
    python experiments/robot/aloha/preprocess_split_aloha_data.py \
        --dataset_path /path/to/aloha1_raw/put_red_pepper_into_pot/ \
        --out_base_dir /path/to/aloha1_preprocessed/ \
        --percent_val 0.05 && \
    python experiments/robot/aloha/preprocess_split_aloha_data.py \
        --dataset_path /path/to/aloha1_raw/put_yellow_corn_into_pot/ \
        --out_base_dir /path/to/aloha1_preprocessed/ \
        --percent_val 0.05
"""
